...
import { PagingServerComponent } from './paging-server/paging-server.component';
...
const routes: Routes = [
    ...
    { path: 'pagingcliente', component: PagingClientComponent },
    { path: 'serverpagin', component: PagingServerComponent },
